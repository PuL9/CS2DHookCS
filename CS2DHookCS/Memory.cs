...
namespace CS2DHookCS
{
    public static class Memory
    {
        ...
        public static T GetFunction<T>(string signature)
        {
            return Marshal.GetDelegateForFunctionPointer<T>(Memory.FixedAobscan(signature));
        }
        ...
        /// <summary>
        /// Scan in pre-defined address space
        /// </summary>
        /// <param name="signature"></param>
        /// <returns>Address of found signature</returns>
        public static IntPtr FixedAobscan(string signature)
        {
            return Aobscan(0x400000, 0x300000, signature);
        }
        #endregion Aobscan
    }
}