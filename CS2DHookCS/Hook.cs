...
namespace CS2DHookCS
{
    public class Hook
    {
        ...
        public void SetCall()
        {
            ...
            var asm_bytes = new List<byte> { 0xE8 };
            ...
            VirtualProtect(HookAddress, asm_bytes.Count, (int)Protection.PAGE_EXECUTE_READWRITE, out int oldProtect);
        ...
        public void SetPointer()
        {
            ...
            VirtualProtect(HookAddress, IntPtr.Size, (int)Protection.PAGE_EXECUTE_READWRITE, out int oldProtect);
        ...
        public void SetJump()
        {
            ...
            var asm_bytes = new List<byte> { 0xE9 };
            asm_bytes.AddRange(BitConverter.GetBytes(callbackAddress.ToInt32() - HookAddress.ToInt32() - 5));
        ...
        {
            VirtualProtect(HookAddress, OldBytes.Length, (int)Protection.PAGE_EXECUTE_READWRITE, out int oldProtect);
