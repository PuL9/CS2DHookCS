...
namespace CS2DHookCS.CS2D
{
    public static class Patches
    {
        ...
        public static Patch AntiFlash = new Patch(Signatures.Antiflash, 3)
        {
            On = new byte[] { 0x83, 0xF8, 0x01 },
            Off = new byte[] { 0x83, 0xF8, 0x00 }
        };
        ...
        public static Patch AntiCE = new Patch(Signatures.AntiCE, 1, 4)
        {
            On = new byte[] { 0xEB }
        };
    }
